...
module.exports = function(req, res) {
    ...
    rideService.getCompletedRidesCsvFile().then(function(user) {
        if (!user) {
        ...
        json2csv({
            ...
            fs.writeFile('public/uploads/completedridesfile.csv', csv, function(err) {
                if (err) throw err;
                console.log('file saved');
                res.download('public/uploads/completedridesfile.csv');
            });
        })
    }).catch(function(err) {
