...
module.exports = function(req, res) {
    ...
    rideService.getNoShowRidesCsvFile().then(function(user) {
        if (!user) {
        ...
        json2csv({
            ...
            fs.writeFile('public/uploads/noshowridesfile.csv', csv, function(err) {
                if (err) throw err;
                console.log('file saved');
                res.download('public/uploads/noshowridesfile.csv');
            });
        })
    }).catch(function(err) {
