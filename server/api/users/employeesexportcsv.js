...
module.exports = function(req, res, next) {
    ...
    userService.getEmployeeCsvFile().then(function(user) {
        if (!user) {
        ...
        json2csv({
            ...
            fs.writeFile('public/uploads/employeefile.csv', csv, function(err) {
                if (err) throw err;
                console.log('file saved');
                res.download('public/uploads/employeefile.csv');
            });
        })
    }).catch(function(err) {
